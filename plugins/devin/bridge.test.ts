...
const catalog = buildDevinModels({ families: [{ family_uid: "test", family_label: "Test", variants: [
...
const experimental_providerBridge = withDevinUsage(withDevinModels(experimental_acpProviderBridge, async () => catalog));
