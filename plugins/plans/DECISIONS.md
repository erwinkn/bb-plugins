...
| D06 | Unsent comments and redlines block approval; sent feedback requires a new revision. Looks good does not block approval. | Allow approval with open comments. | Medium | Sent feedback stays in the history and does not block a newer revision. |
