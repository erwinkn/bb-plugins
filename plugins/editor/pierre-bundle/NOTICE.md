...
`assets/pierre` is a browser bundle built by `scripts/stage-assets.mjs` from the
packages below. The build writes the full license texts of every package it
included to `assets/pierre/LICENSES.txt`. Keep that file with the bundle when you
distribute a built copy of this plugin.

| Package | Version | License |
| --- | --- | --- |
| `@pierre/diffs` | 1.4.1 | Apache-2.0 |
| `@pierre/theme` | 2.0.0 | see `assets/pierre/LICENSES.txt` |
| `@pierre/theming` | 1.0.1 | see `assets/pierre/LICENSES.txt` |
...
license and the attribution notices. `assets/pierre/LICENSES.txt` satisfies that,
