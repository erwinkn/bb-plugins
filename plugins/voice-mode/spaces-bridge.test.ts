...
import { CLIENT_STATE_EVENT, CLIENT_STATE_KEY, SPACES_CACHE_KEY, applySpace, currentSpace, readSpaces, resolveSpace } from "./spaces-bridge.ts";
...
const ACTIVITY_CACHE = activityConstant("use-spaces.ts", "SPACES_CACHE_KEY"), ACTIVITY_STATE = activityConstant("client-state.ts", "CLIENT_STATE_KEY"), ACTIVITY_EVENT = activityConstant("client-state.ts", "CLIENT_STATE_EVENT");
